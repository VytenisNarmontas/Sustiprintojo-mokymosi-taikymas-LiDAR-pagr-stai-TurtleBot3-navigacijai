...
The raw PPO model shows that learning directly from LiDAR and odometry was difficult in this setting. The rule-based controller and the PPO controller with LiDAR-derived geometric helper information both reached high success rates, but the residual/helper PPO had fewer collisions in the final 100-episode set.
